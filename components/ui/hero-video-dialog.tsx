...
export function HeroVideoDialog({
  ...
  return (
    <div className={cn("relative", className)}>
      <div className="relative rounded-[35px] cursor-pointer group" onClick={() => setIsVideoOpen(true)}>
        <Image
          src={thumbnailSrc}
          alt={thumbnailAlt}
          width={1920}
          height={1080}
          className=" transition-all max-h-[557px] w-[100%] object-cover duration-200 rounded-[35px] group-hover:brightness-[0.8] ease-out  shadow-lg "
        />
        <div className="absolute inset-0 rounded-[35px] flex items-center justify-center group-hover:scale-100 scale-[0.9] transition-all duration-200 ease-out ">
